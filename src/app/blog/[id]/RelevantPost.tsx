...
const RelevantPost: React.FC<RelevantPostProps> = async({
  ...
  return (
      <div className={`${className} relative mt-16 bg-neutral-100 py-16 dark:bg-neutral-800 lg:mt-24 lg:py-28`}>
        <div className="container max-h-[340px]">
          <h2 className="text-3xl font-semibold">Related posts</h2>
          <div className=" h-full mt-10 grid gap-6 sm:grid-cols-2 md:gap-8 lg:grid-cols-3 xl:grid-cols-4">
            {/*  */}
