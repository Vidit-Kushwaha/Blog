...
const Search: React.FC<SearchProps> = () => {
  ...
  return (
    <div className="relative w-full" ref={ref}>
      <div className="relative mx-auto flex w-full items-center rounded-xl border bg-white p-2 shadow-lg">
              ...
              data.data.map((item, index) => {
                ...
                return (
                  <div key={index} className="flex px-3 py-2">
                    <div className="font-nunito-sans mx-auto block w-full max-w-[58.44rem] truncate border-none bg-transparent bg-white p-0 font-normal text-gray-400 placeholder-gray-400 focus:placeholder-neutral-400 focus:outline-none focus:ring-0 dark:placeholder-neutral-200 xl:text-base">
